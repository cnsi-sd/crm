@extends('layouts.vertical', ["page_title"=> "Form Advanced"])
...
<!-- third party js -->
<script src="{{asset('assets/libs/handlebars/handlebars.min.js')}}"></script>
<script src="{{asset('assets/libs/typeahead/typeahead.min.js')}}"></script>
