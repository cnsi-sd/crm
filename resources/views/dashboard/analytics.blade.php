@extends('layouts.vertical', ["page_title"=> "Analytics Dashboard"])
            ...
            <div class="card cta-box overflow-hidden">
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        ...
                        <img class="ms-3" src="{{asset('assets/images/email-campaign.svg')}}" width="92" alt="Generic placeholder image">
                    </div>
                </div>
                <!-- end card-body -->
            </div>
