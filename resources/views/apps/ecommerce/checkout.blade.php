@extends('layouts.vertical', ["page_title"=> "Checkout"])
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    ...
                                    <form>
                                        ...
                                        <div class="row mt-4">
                                            <div class="col-sm-6">
                                                <a href="{{route('third', ['apps', 'ecommerce', 'shopping-cart'])}}" class="btn text-muted d-none d-sm-inline-block btn-link fw-semibold">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <p class="m-0 d-inline-block align-middle">
                                                                <a href="{{route('third', ['apps', 'ecommerce', 'products-details'])}}" class="text-body fw-semibold">Amazing Modern Chair</a>
                                                                <br>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <p class="m-0 d-inline-block align-middle">
                                                                <a href="{{route('third', ['apps', 'ecommerce', 'products-details'])}}" class="text-body fw-semibold">Designer Awesome Chair</a>
                                                                <br>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <p class="m-0 d-inline-block align-middle">
                                                                <a href="{{route('third', ['apps', 'ecommerce', 'products-details'])}}" class="text-body fw-semibold">Biblio Plastic Armchair</a>
                                                                <br>
