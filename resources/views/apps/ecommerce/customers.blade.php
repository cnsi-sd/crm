@extends('layouts.vertical', ["page_title"=> "Customers"])
                        ...
                        <table class="table table-centered table-striped dt-responsive nowrap w-100" id="products-datatable">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="table-user">
                                        <img src="{{asset('assets/images/users/avatar-1.jpg')}}" alt="table-user" class="me-2 rounded-circle">
                                ...
                                <tr>
                                    ...
                                    <td class="table-user">
                                        <img src="{{asset('assets/images/users/avatar-10.jpg')}}" alt="table-user" class="me-2 rounded-circle">
