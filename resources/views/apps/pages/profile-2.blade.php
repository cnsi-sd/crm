                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane show active" id="timeline">
                            ...
                            <div class="border border-light rounded p-2 mb-3">
                                <div class="d-flex">
                                    <img class="me-2 rounded-circle" src="{{asset('assets/images/users/avatar-3.jpg')}}" alt="Generic placeholder image" height="32">
                                    <div>
                                ...
                                <img src="{{asset('assets/images/small/small-1.jpg')}}" alt="post-img" class="rounded me-1" height="60" />
                                <img src="{{asset('assets/images/small/small-2.jpg')}}" alt="post-img" class="rounded me-1" height="60" />
                                <img src="{{asset('assets/images/small/small-3.jpg')}}" alt="post-img" class="rounded" height="60" />
                            ...
                            <div class="border border-light rounded p-2 mb-3">
                                <div class="d-flex">
                                    <img class="me-2 rounded-circle" src="{{asset('assets/images/users/avatar-4.jpg')}}" alt="Generic placeholder image" height="32">
                                    <div>
                                ...
                                <div class="mx-n2 p-2 mt-3 bg-light">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            ...
                                            <div class="d-flex mt-3">
                                                <a class="pe-2" href="#">
                                                    <img src="{{asset('assets/images/users/avatar-4.jpg')}}" class="rounded-circle" alt="Generic placeholder image" height="32">
                                                </a>
                                                <div>
                                    ...
                                    <div class="d-flex mt-2">
                                        <a class="pe-2" href="#">
                                            <img src="{{asset('assets/images/users/avatar-1.jpg')}}" class="rounded-circle" alt="Generic placeholder image" height="32">
                                        </a>
                                        <div class="w-100">
                            ...
                            <div class="border border-light p-2 mb-3">
                                <div class="d-flex">
                                    <img class="me-2 rounded-circle" src="{{asset('assets/images/users/avatar-6.jpg')}}" alt="Generic placeholder image" height="32">
                                    <div>
