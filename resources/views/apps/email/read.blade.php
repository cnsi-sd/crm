@extends('layouts.vertical', ["page_title"=> "Email Read"])

@section('css')
<!-- third party css -->
<link href="{{asset('assets/libs/simplemde/simplemde.min.css')}}" rel="stylesheet" type="text/css" />
<!-- third party css end -->
                    ...
                    <div class="page-aside-right">
                        ...
                        <div class="mt-3">
                            ...
                            <div class="d-flex mb-3 mt-1">
                                <img class="d-flex me-2 rounded-circle" src="{{asset('assets/images/users/avatar-2.jpg')}}" alt="placeholder image" height="32">
...
<!-- third party js -->
<script src="{{asset('assets/libs/simplemde/simplemde.min.js')}}"></script>
<!-- third party js ends -->
