@extends('layouts.vertical', ["page_title"=> "Project Overview"])
                ...
                <div class="card-body">
                    ...
                    <div id="tooltip-container">
                        ...
                        <a href="javascript:void(0);" data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Mat Helme" class="d-inline-block">
                            <img src="{{asset('assets/images/users/avatar-6.jpg')}}" class="rounded-circle img-thumbnail avatar-sm" alt="friend">
                        </a>
                        ...
                        <a href="javascript:void(0);" data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Michael Zenaty" class="d-inline-block">
                            <img src="{{asset('assets/images/users/avatar-7.jpg')}}" class="rounded-circle img-thumbnail avatar-sm" alt="friend">
                        </a>
                        ...
                        <a href="javascript:void(0);" data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top" title="James Anderson" class="d-inline-block">
                            <img src="{{asset('assets/images/users/avatar-8.jpg')}}" class="rounded-circle img-thumbnail avatar-sm" alt="friend">
                        </a>

                        <a href="javascript:void(0);" data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Mat Helme" class="d-inline-block">
                            <img src="{{asset('assets/images/users/avatar-4.jpg')}}" class="rounded-circle img-thumbnail avatar-sm" alt="friend">
                        </a>

                        <a href="javascript:void(0);" data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Michael Zenaty" class="d-inline-block">
                            <img src="{{asset('assets/images/users/avatar-5.jpg')}}" class="rounded-circle img-thumbnail avatar-sm" alt="friend">
                        </a>

                        <a href="javascript:void(0);" data-bs-container="#tooltip-container" data-bs-toggle="tooltip" data-bs-placement="top" title="James Anderson" class="d-inline-block">
                            <img src="{{asset('assets/images/users/avatar-3.jpg')}}" class="rounded-circle img-thumbnail avatar-sm" alt="friend">
                        </a>
                    </div>
...
<!-- demo app -->
<script src="{{asset('assets/js/pages/demo.project-detail.js')}}"></script>
<!-- end demo js-->
@endsection