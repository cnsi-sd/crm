@extends('layouts.vertical', ["page_title"=> "Projects"])
...
<div class="container-fluid">
    ...
    <div class="row mb-2">
        <div class="col-sm-4">
            <a href="{{route('third', ['apps', 'projects', 'add'])}}" class="btn btn-danger btn-rounded mb-3"><i class="mdi mdi-plus"></i> Create Project</a>
        </div>
        <div class="col-sm-8">
        ...
        <div class="col-lg-6 col-xxl-3">
            ...
            <div class="card d-block">
                <div class="card-body">
                    ...
                    <!-- project title-->
                    <h4 class="mt-0">
                        <a href="{{route('third', ['apps', 'projects', 'details'])}}" class="text-title">App design and development</a>
                    </h4>
        ...
        <div class="col-md-6 col-xxl-3">
            ...
            <div class="card d-block">
                <div class="card-body">
                    ...
                    <!-- project title-->
                    <h4 class="mt-0">
                        <a href="{{route('third', ['apps', 'projects', 'details'])}}" class="text-title">Coffee detail page - Main Page</a>
                    </h4>
                    ...
                    <div id="tooltip-container1">
                        <a href="javascript:void(0);" data-bs-container="#tooltip-container1" data-bs-toggle="tooltip" data-bs-placement="top" title="Mat Helme" class="d-inline-block">
                            <img src="{{asset('assets/images/users/avatar-1.jpg')}}" class="rounded-circle avatar-xs" alt="friend">
                        </a>
                        ...
                        <a href="javascript:void(0);" data-bs-container="#tooltip-container1" data-bs-toggle="tooltip" data-bs-placement="top" title="Michael Zenaty" class="d-inline-block">
                            <img src="{{asset('assets/images/users/avatar-2.jpg')}}" class="rounded-circle avatar-xs" alt="friend">
                        </a>
        ...
        <div class="col-md-6 col-xxl-3">
            ...
            <div class="card d-block">
                <div class="card-body">
                    ...
                    <!-- project title-->
                    <h4 class="mt-0">
                        <a href="{{route('third', ['apps', 'projects', 'details'])}}" class="text-title">Poster illustation design</a>
                    </h4>
                    <div class="badge bg-secondary text-light mb-3">Ongoing</div>
        ...
        <div class="col-md-6 col-xxl-3">
            ...
            <div class="card d-block">
                <div class="card-body">
                    ...
                    <!-- project title-->
                    <h4 class="mt-0">
                        <a href="{{route('third', ['apps', 'projects', 'details'])}}" class="text-title">Drinking bottle graphics </a>
                    </h4>
                    <div class="badge bg-success mb-3">Finished</div>
    ...
    <div class="row">
        <div class="col-md-6 col-xxl-3">
            ...
            <div class="card d-block">
                ...
                <div class="card-body position-relative">
                    <!-- project title-->
                    <h4 class="mt-0">
                        <a href="{{route('third', ['apps', 'projects', 'details'])}}" class="text-title">Company logo design</a>
                    </h4>
        ...
        <div class="col-md-6 col-xxl-3">
            ...
            <div class="card d-block">
                ...
                <div class="card-body position-relative">
                    <!-- project title-->
                    <h4 class="mt-0">
                        <a href="{{route('third', ['apps', 'projects', 'details'])}}" class="text-title">Landing page design - Home</a>
                    </h4>
        ...
        <div class="col-md-6 col-xxl-3">
            ...
            <div class="card d-block">
                <!-- project-thumbnail -->
                <img class="card-img-top" src="{{asset('assets/images/projects/project-3.jpg')}}" alt="project image cap">
                <div class="card-img-overlay">
                    <div class="badge bg-secondary text-light p-1">Ongoing</div>
                </div>
                ...
                <div class="card-body position-relative">
                    <!-- project title-->
                    <h4 class="mt-0">
                        <a href="{{route('third', ['apps', 'projects', 'details'])}}" class="text-title">Product page redesign</a>
                    </h4>
        ...
        <div class="col-md-6 col-xxl-3">
            ...
            <div class="card d-block">
                <!-- project-thumbnail -->
                <img class="card-img-top" src="{{asset('assets/images/projects/project-4.jpg')}}" alt="project image cap">
                <div class="card-img-overlay">
                    <div class="badge bg-secondary text-light p-1">Ongoing</div>
                </div>
