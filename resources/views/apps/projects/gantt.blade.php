@extends('layouts.vertical', ["page_title"=> "Projects Calendar"])

@section('css')
<!-- third party css -->
<link rel="stylesheet" href="{{asset('assets/libs/frappe-gantt/frappe-gantt.min.css')}}">
<!-- third party css end -->
@endsection
...
<!-- third party js -->
<script src="{{asset('assets/libs/frappe-gantt/frappe-gantt.min.js')}}"></script>
<!-- third party js ends -->
