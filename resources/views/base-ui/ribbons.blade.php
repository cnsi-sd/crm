@extends('layouts.vertical', ["page_title"=> "Ribbons"])
                ...
                <div class="tab-pane show active" id="ribbons-preview">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="card ribbon-box">
                                <div class="card-body">
                                    <div class="ribbon ribbon-dark float-end"><i class="mdi mdi-access-point me-1"></i> Dark</div>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="card ribbon-box">
                                <div class="card-body">
                                    <div class="ribbon ribbon-secondary text-light float-start"><i class="mdi mdi-access-point me-1"></i> Secondary</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="card ribbon-box">
                                <div class="card-body">
                                    <div class="ribbon-two ribbon-two-secondary"><span class="text-light">Secondary</span></div>
                                    <p class="mb-0">Quisque nec turpis at urna dictum luctus. Suspendisse
                                        convallis dignissim eros at volutpat. In egestas mattis dui. Aliquam
                                        mattis dictum aliquet. Nulla sapien mauris, eleifend et sem ac,
                                        commodo dapibus odio. Vivamus pretium nec odio cursus elementum.
