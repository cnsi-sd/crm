@extends('layouts.horizontal', ["page_title"=> "Widgets"])
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div class="w-100 overflow-hidden">
                            ...
                            <h3 class="m-0 fw-normal cta-box-title">Enhance your <b>Campaign</b> for better outreach <i class="mdi mdi-arrow-right-bold-outline"></i></h3>
                        </div>
            ...
            <div class="card cta-box bg-primary text-white">
                <div class="card-body">
                    <div class="text-center">
                        ...
                        <img class="my-3" src="{{asset('assets/images/report.svg')}}" width="180" alt="Generic placeholder image">
